...
public class SimpleMailSender {
	 ...
	 * @throws MessagingException
	 */
	// public void send(String recipient, SimpleMail com.cui.mail) throws
	// AddressException, MessagingException {
	// send(recipient, com.cui.mail.getSubject(), com.cui.mail.getContent());
	// }
	 ...
	 * @throws MessagingException
	 */
	// public void send(List<String> recipients, SimpleMail com.cui.mail) throws
	// AddressException, MessagingException {
	// send(recipients, com.cui.mail.getSubject(), com.cui.mail.getContent());
	// }

	public static void main(String[] args) throws FileNotFoundException, IOException, AddressException, MessagingException {
		// Properties props = new Properties();
		// props.put("com.cui.mail.smtp.host", "smtp.163.com");
		// props.put("com.cui.mail.from", "cuilovexing@163.com");
		// props.put("com.cui.mail.smtp.auth", "true");
