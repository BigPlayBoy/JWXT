...
public class TestMail {
	...
	public static void main(String[] args) throws Exception {
		...
		// //props.put("com.cui.mail.smtp.host", "smtp.163.com");//设置host地址
		// //props.put("com.cui.mail.smtp.auth", "true");//是否验证
		// //基本的邮件会话
		...
		// //Exception in thread "com.cui.main" javax.com.cui.mail.NoSuchProviderException: smtp
